...
from app import request_handler, search_candidates, get_photo_and_home_url
            ...
            if event.to_me:
                ...
                if check_for_registration(id) is False:
                    write_msg(id, f"Здравствуйте, {name}.\n"
                                  ...
                                  f"Добро пожаловать!\n"
                                  f"Вижу Вы ещё не зарегистрированы.\n"
                    ...
                    if user_act == "new_user" and msg == "да" or \
                       user_act == "yes" and "токен" not in msg:
                        ...
                        write_msg(id, f"Жаль! Но мы сможем сделать это позже.\n"
